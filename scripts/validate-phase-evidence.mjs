...
for (const evidence of [
  ...
  "embedded_signature_analyzer_ignores_header_collisions_before_candidate_cap",
  "jpeg_segment_analyzer_extracts_packet_payload_from_comment_segment",
  "jpeg_segment_analyzer_skips_corrupt_packet_decoys_before_valid_comment_packet",
  "jpeg_segment_analyzer_extracts_multiple_packet_payloads_from_single_comment_segment",
  ...
  "jpeg_segment_analyzer_skips_corrupt_packet_decoys_before_valid_after_eoi_packet",
  "jpeg_segment_analyzer_prefers_verified_after_eoi_packet_over_segment_signature_candidates",
  "jpeg_segment_analyzer_labels_post_eoi_data_as_after_eoi_not_segment",
  "jpeg_segment_analyzer_rejects_invalid_after_eoi_packet_and_keeps_signature_fallback",
  "jpeg_segment_analyzer_extracts_valid_signature_from_app_segment",
  "jpeg_segment_analyzer_extracts_packet_payload_from_app_segment",
  "jpeg_segment_analyzer_skips_invalid_signature_decoys_before_valid_segment_signature",
  ...
  "jpeg_segment_analyzer_streams_past_dense_payload_headers",
  ...
  "jpeg_segment_analyzer_rejects_pre_sos_restart_after_payload_segment",
  ...
  "jpeg_segment_analyzer_accepts_fill_prefixed_structural_eoi_for_trailing_payload",
  "jpeg_segment_analyzer_does_not_treat_comment_data_after_false_eoi_as_trailing_payload",
  "jpeg_segment_analyzer_does_not_treat_app_data_after_false_eoi_as_trailing_payload",
  ...
  "jpeg_segment_analyzer_ignores_fill_prefixed_byte_stuffed_eoi_in_sos_scan_data",
  "jpeg_segment_analyzer_ignores_restart_and_fill_markers_in_sos_scan_data",
  "jpeg_segment_analyzer_ignores_tem_marker_in_sos_scan_data",
  ...
  "jpeg_segment_analyzer_ignores_false_eoi_after_length_shaped_scan_soi_decoy",
  "jpeg_segment_analyzer_finds_eoi_after_length_like_scan_soi_decoy",
  "jpeg_segment_analyzer_skips_post_sos_segment_payload_when_finding_after_eoi",
  "jpeg_segment_analyzer_preserves_distinct_same_name_packets_from_multiple_segments",
  "jpeg_segment_analyzer_preserves_distinct_same_name_packets_from_segment_and_after_eoi",
  "jpeg_segment_analyzer_rejects_nested_soi_marker_before_payloads",
  "jpeg_segment_analyzer_rejects_length_shaped_nested_soi_marker_before_payloads",
...
expectMatch(
  ...
  phaseReadinessDocs,
  /July 4, 2026 KST JPEG SOI-decoy hardening refresh[\s\S]*?`npm run validate:static` \(86 download IPC checks and\s+284 phase\s+evidence\s+checks\)/,
);
expectMatch(
